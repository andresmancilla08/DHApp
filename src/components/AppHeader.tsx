...
export function AppHeader({ username }: { username: string }) {
  return (
    <header
      ...
      style={{ background: "radial-gradient(ellipse 92% 135% at 50% -8%, var(--background) 0%, var(--background) 34%, transparent 72%)" }}
    >
      <div className="mx-auto flex w-full max-w-2xl items-center justify-between px-4 pb-6 pt-[10px]">
